...
$user_query=mysqli_query($db,"SELECT users.id FROM users where users.name='".$_SESSION['login']."'");
...
<col class='esg'><col class='season'><col class='season'><col class='season'><col class='season'><col class='act'><col class='status'><thead>
...
<tbody>
<?php
$sb_lst_query=mysqli_query($db,"SELECT * from sblist WHERE sblist.id IN (SELECT viewed.sb_id FROM `viewed` WHERE viewed.user_id='".$user['id']."' and viewed.view=0) ORDER BY sblist.id asc");
$x=1;
...
<td><center>
<img src="images/<?php echo $bgcol;?>" height="12" width="12"></center><span style="visibility:hidden;"><?php echo $stat;?></span>
</td>
</tr>
<?php } ?>
