...
?>
<tr onClick="popupWin = window.open('edit/task.php<?php echo ("?id=".$tasks_lst['id']);?>', 'Р”РѕР±Р°РІРёС‚СЊ Р·Р°РґР°С‡Сѓ', 'location,width=800,height=550,top=0'); popupWin.focus(); return false;" style="padding-left:90px;">
