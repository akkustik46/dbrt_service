...
<?php $work_lst_query=mysqli_query($db,"SELECT * FROM works WHERE task_id='".$tasks_lst['id']."'");
                while ($works_lst=mysqli_fetch_array($work_lst_query)) {
                            ...
                            echo ("<details><summary>Подробиці</summary>".$wrk['group_name']." > ".$wrk['name']);
                            if ($works_lst['status']==1) {echo "   <img src=/images/green.png height='12px' width='12px'></details><br>";} else {echo "   <img src=/images/red.png height='12px' width='12px'></details><br>";}
                        }
            ?>
</td>
<td></td>
