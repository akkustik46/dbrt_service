...
"<a href='add/client.php' target='_blank' onClick=\"popupWin = window.open(this.href, 'AddClient', 'location=no,width=470,height=300,top=200,left=60'); popupWin.focus(); return false;\">Добавить клиента</a>".
"</p>";
    }
?>
<p>
