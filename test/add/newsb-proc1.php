...
mysql_query("INSERT INTO sblist (sblist.sbno, sblist.title, sblist.atasys, sblist.vendor, sblist.rev, sblist.ad_note, sblist.release_date, sblist.affected, sblist.effectivity, sblist.acc_category, 
				...
				'".$_SESSION['post']['labor_rate']."', '".$_SESSION['post']['mhr_cost']."', \"".$_SESSION['post']['kit_req']."\", '".$_SESSION['post']['kit_price']."', \"".$_SESSION['post']['esg_eng']."\",
				 \"".$_SESSION['post']['esg_lead_eng']."\", \"".$_SESSION['post']['mcg_lead_eng']."\", 
				\"".$_SESSION['post']['esg_dep_man']."\", '".$_SESSION['post']['eval_issued']."', '".$_SESSION['post']['eojo_no']."', '".$_SESSION['post']['rev_before']."', '".$user['id']."', 'added')");
mysql_query("INSERT INTO sblist_history (sblist_history.sbno, sblist_history.title, sblist_history.atasys, sblist_history.vendor, sblist_history.rev, sblist_history.ad_note, sblist_history.release_date, sblist_history.affected,
				...
				'".$_SESSION['post']['labor_rate']."', '".$_SESSION['post']['mhr_cost']."', \"".$_SESSION['post']['kit_req']."\", '".$_SESSION['post']['kit_price']."', \"".$_SESSION['post']['esg_eng']."\",
				 \"".$_SESSION['post']['esg_lead_eng']."\", \"".$_SESSION['post']['mcg_lead_eng']."\",
				\"".$_SESSION['post']['esg_dep_man']."\", '".$_SESSION['post']['eval_issued']."', '".$_SESSION['post']['eojo_no']."', '".$_SESSION['post']['rev_before']."', '".$_SESSION['post']['user']."', '".$_SESSION['post']['action']."')");
