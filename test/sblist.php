...
<div id="noty" class="notification"><?php include('notify.php'); ?></div> 
...
<col class='esg'><col class='season'><col class='status'><col class='season'><col class='season'><col class='act'><thead>
...
<th axis="str">ESG Lead Engineer&nbsp;</th><th axis="str">MCG Lead Enginer&nbsp;</th><th axis="str">ESG Manager&nbsp;</th><th>Evaluation date&nbsp;</th><th>Action&nbsp;</th></tr>
</thead>
<tbody>
<?php
if ($_GET['action']=='all') {
