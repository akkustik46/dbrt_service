...
(function () {
	...
	T.msg.innerHTML = "&bull; Hide: ESC. &bull; "
	...
	navig.innerHTML = '<button onclick="move(-1,true); return false;" title="First (Ctrl + Alt + &larr;)"><span>&lt;&lt;</span></button>\
<button onclick="move(-1); return false;" title="Prev (Ctrl + &larr;)"><span>&lt;</span></button>\
<span>Page </span><span class=\'pagenum\'></span> from <span class=\'pageall\'></span> \
<button onclick="move(1); return false;" title="Next (Ctrl + &rarr;)"><span>&gt;</span></button>\
<button onclick="move(1,true); return false;" title="Last (Ctrl + Alt + &rarr;)"><span>&gt;&gt;</span></button>\
<span>On page <input class="page_size"> string </span>\
<button class="set"><span>Set</span></button> \
'
