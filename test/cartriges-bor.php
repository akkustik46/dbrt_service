...
<br>
 <p>
<a href="add/cartriges-bor.php" target="_blank" onClick="popupWin = window.open(this.href, 'AddCart', 'location,width=400,height=300,top=0'); popupWin.focus(); return false;">Добавить тип</a>
<a href="add/cart-output-bor.php" target="_blank" onClick="popupWin = window.open(this.href, 'AddCart', 'location,width=500,height=550,top=0,scrollbars=yes'); popupWin.focus(); return false;">Выдать картридж</a>
<a href="add/cart-charge-bor.php" target="_blank" onClick="popupWin = window.open(this.href, 'AddCart', 'location,width=800,height=500,top=0,scrollbars=yes'); popupWin.focus(); return false;">Заправка</a>
<a href="add/cart-add-bor.php" target="_blank" onClick="popupWin = window.open(this.href, 'AddCart', 'location,width=850,height=500,top=0,scrollbars=yes'); popupWin.focus(); return false;">Добавить в наличие</a>
<a href="add/cart-charge-proc-bor.php?action=all" target="_self" onClick="if(confirm('Уверены что хотите отправить все на заправку?')) return true; else return false;">На заправку все</a>
</p>

<p>

<b>Наличие картриджей Бориполь</b>
<br>
...
<?php
$cart_lst_query=mysql_query("SELECT * FROM cartriges_work_bor");
$x=1;
