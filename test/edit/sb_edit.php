...
<form action="editsb-proc.php" method="post">
...
case 4:
	...
	Reliability mandatory<input type='radio' name='acc_cat' value='2'><Br>
	    Recommended<input type='radio' name='acc_cat' value='3'><br>
	Optional<input type='radio' name='acc_cat' value='4' checked=checke>";
break;
...
switch($sb_lst['priority']) {case 1:
	...
	As scheduled by PPC<input type='radio' name='priority' value='3'><br>
	Optional<input type='radio' name='priority' value='4'><br><br>";
break;
case 2:
...
case 3:
    echo "Next check/shop visit<input type='radio' name='priority' value='1'><Br>
	Next heavy maint visit<input type='radio' name='priority' value='2'><Br>
	As scheduled by PPC<input type='radio' name='priority' value='3' checked=checked><br>
	Optional<input type='radio' name='priority' value='4'><br><br>";
break;
case 4:
    echo "Next check/shop visit<input type='radio' name='priority' value='1'><Br>
	Next heavy maint visit<input type='radio' name='priority' value='2'><Br>
	As scheduled by PPC<input type='radio' name='priority' value='3'><br>
	Optional<input type='radio' name='priority' value='4' checked=checked>><br><br>";
break;
default:
    echo "Next check/shop visit<input type='radio' name='priority' value='1'><Br>
	Next heavy maint visit<input type='radio' name='priority' value='2'><Br>
...
Engineering Support Group Engineer</td>
<td colspan="3"><textarea rows="3" cols="100" name="esg_eng"><?php echo ($sb_lst['esg_eng']); ?></textarea>
</td>
</tr>
...
<?php if($pos['name']=='ESG Leading Engeneer') {
 echo "<textarea rows=\"3\" cols=\"30\" name=\"esg_lead_eng\">".$sb_lst['esg_lead_eng']."</textarea>";
    } else {
    echo "<p style=\"border: 0px solid black; padding: 10px; background: white;\">".$sb_lst['esg_lead_eng']."</p>
    <input type=\"hidden\" name=\"esg_lead_eng\" value=\"".$sb_lst['esg_lead_eng']."\"></input>";
    }
?>
</td>
<td>
...
<?php if($pos['name']=='MCG Leading Engineer') {
 echo "<textarea rows=\"3\" cols=\"30\" name=\"mcg_lead_eng\">".$sb_lst['mcg_lead_eng']."</textarea>";
    } else {
    echo "<p style=\"border: 0px solid black; padding: 10px; background: white;\">".$sb_lst['mcg_lead_eng']."</p>
    <input type=\"hidden\" name=\"mcg_lead_eng\" value=\"".$sb_lst['mcg_lead_eng']."\"></input>";
    }
?>
</td>
</tr>
...
<?php if($pos['name']=='ESD Manager') {
 echo "<textarea rows=\"3\" cols=\"30\" name=\"esg_dep_man\">".$sb_lst['esd_manager']."</textarea>";
    } else {
    echo "<p style=\"border: 0px solid black; padding: 10px; background: white;\">".$sb_lst['esd_manager']."</p>
	<input type=\"hidden\" name=\"esg_dep_man\" value=\"".$sb_lst['esd_manager']."\"></input>";
    }
?>
...
<input type="hidden" name="action" value="edited"></input>
