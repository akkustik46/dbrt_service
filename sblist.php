...
<div id="notify" class="notification"><?php include('notify.php'); ?></div> 
...
<col class='esg'><col class='season'><col class='season'><col class='season'><col class='season'><col class='act'><col class='stat'><thead>
...
if ($_GET['action']=='all') {
$sb_lst_query=mysqli_query($db,"SELECT * from sblist ORDER BY sblist.id asc");
    } else {
	$sb_lst_query=mysqli_query($db,"select * from sblist where sblist.sbno rlike '^".$_GET['action']."'");
    }
$x=1;
while ($sb_lst = mysqli_fetch_array($sb_lst_query)) {
...
//$status=strtolower($sb_lst['esg_lead_eng']);
$status=str_ireplace($_SESSION['login'].': ','', $sb_lst['esg_lead_eng']);
...
$stat="OK";
//echo "true<br>";
    } else { if ($sb_lst['esg_lead_eng']=='') {$bgcol='red.png'; $stat="NA";} else {
$bgcol='yellow.png';
$stat="NC";
//    echo "false<br>";
        }
...
$status=str_ireplace($_SESSION['login'].': ','', $sb_lst['mcg_lead_eng']);
$status=strtolower($status);
...
break;
case 'ESD Manager':
$status=str_ireplace($_SESSION['login'].': ','', $sb_lst['esd_manager']);
$status=strtolower($status);
...
$stat="OK";
//echo "true<br>";
    } else { if ($sb_lst['esd_manager']=='') {$bgcol='red.png'; $stat="red";} else {
$bgcol='yellow.png';
$stat="Not confirmed";
//    echo "false<br>";
        }
...
$stat="OK";
//echo "true<br>";
    } else { if ($sb_lst['esd_manager']=='') {$bgcol='red.png'; $stat="NA";} else {
$bgcol='yellow.png';
$stat="NC";
//    echo "false<br>";
        }
...
<td><?php
        $ven_lst_query=mysqli_query($db,"SELECT vendor.name FROM vendor WHERE vendor.id='".$sb_lst['vendor']."'");
        while ($ven_lst=mysqli_fetch_array($ven_lst_query)) {
