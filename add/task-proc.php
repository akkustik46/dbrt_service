...
$result=mysqli_query($db,"INSERT INTO tasks (date_create, comment, client, bike, mileage, status) VALUES (now(),'".$_POST['comment']."','".$_POST['cl_id']."','".$_POST['bike_id']."','".$_POST['mileage']."','".$_POST['status']."')");
//print_r($result);
//echo mysql_error();
